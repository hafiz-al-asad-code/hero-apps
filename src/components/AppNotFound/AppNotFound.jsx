...
const AppNotFound = ({ setFilteredApps, appsData }) => {
  return (
    <div className='text-center py-[80px]'>
      ...
      <button onClick={() => setFilteredApps(appsData)} className='text-white font-semibold bg-gradient-to-r from-[#632ee3] to-[#9f62f2] py-[12px] px-[40.5px] rounded-sm'>Go Back</button>
    </div>
  );
};
