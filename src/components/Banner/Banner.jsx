...
const Banner = () => {
  return (
    <div className='max-w-[1440px] mx-auto text-center'>
      ...
      <p className='text-xl mt-4 mb-10 text-[#627382]'>At HERO.IO , we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.<br /> Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
